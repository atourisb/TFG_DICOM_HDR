...
class ImageConverter8Bits:
    ...
    def process_dicom(self, dicom: dicom_data):
        ...
        pixel_data_modified = self.aplicar_voi_lut(pixel_data_modified, dicom)

        # normalizamos a 16 bit
        pixel_data_modified = ((pixel_data_modified - dicom.get_min_pixel_value()) / (dicom.get_max_pixel_value() - dicom.get_min_pixel_value())) * 255.0
        ...
        pixel_data_modified = pixel_data_modified.astype('uint8')
